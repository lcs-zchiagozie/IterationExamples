...
for i in stride(from: 0, to: 300, by: 20){canvas.drawLine(fromX: i, fromY: 0, toX: 300, toY: i)}

for y in stride(from: 0, to: 300, by: 20){canvas.drawLine(fromX: y, fromY: 300, toX: 0, toY: y)}
